  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-10 pb-4">
        ...
        {/* CTA */}
        <button className="mt-4 w-full rounded-full bg-gradient-primary py-2.5 text-sm font-semibold text-primary-foreground shadow-glow transition-all duration-300 group-hover:shadow-[0_4px_20px_hsl(340_80%_58%_/_0.5)]">
          Assinar agora
        </button>
      </div>
    </Link>
